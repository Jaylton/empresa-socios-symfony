 ...
 */
final class Version20241008002531 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE socio (id INT NOT NULL, empresa_id INT DEFAULT NULL, nome VARCHAR(255) NOT NULL, cpf VARCHAR(11) DEFAULT NULL, PRIMARY KEY(id))');
